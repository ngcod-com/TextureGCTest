...
/*struct FExportedTArrayHelper
{
    static FExportedTArrayHelper StaticInstance;
    FExportedTArrayHelper() 
        : ExportedClass(nullptr)
    { 
        UnLua::IExportedClass *Class = UnLua::FindExportedClass("TArray");
        if (!Class)
        {
            ExportedClass = new UnLua::TExportedClassBase<false>("TArray");
            UnLua::ExportClass(ExportedClass);
            Class = ExportedClass;
        }
        Class->AddLib(TArrayLib);
    }
    ~FExportedTArrayHelper()
    {
...
FExportedTArrayHelper FExportedTArrayHelper::StaticInstance;*/
